...
class AnagramsSuite {
  ...
  @Test def `is_subset 1`: Unit =
    assertEquals(true, is_subset(List(('a', 2), ('b', 1)), List(('a', 2), ('b', 1))))
  @Test def `is_subset 2`: Unit =
    assertEquals(true, is_subset(List(('a', 2), ('b', 1)), List(('a', 2))))
  @Test def `is_subset 3`: Unit =
    assertEquals(false, is_subset(List(('a', 2), ('b', 1)), List(('a', 2), ('c', 1))))
  @Test def `is_subset 4`: Unit =
    assertEquals(false, is_subset(List(('a', 2), ('b', 1)), List(('a', 3))))
